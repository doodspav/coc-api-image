...
class player:
    ...
    def main_picture_info(self):
        ...
        if self.in_clan == True:
            ...
            draw.text((cn_x,cn_y+5), self.clan_name, black, font=cn_font)
    ...
    def builder_picture_info(self):
        ...
        if self.builder_best_trophies > 0:
            ...
            draw.text((atb_x,atb_y+6), str(self.builder_best_trophies), black, font=atb_font)
            draw.text((atb_x,atb_y), str(self.builder_best_trophies), white, font=atb_font)

        #current cups
        cc_font = ImageFont.truetype("cocapifiles/fonts/Supercell-Magic_5.ttf", 50)
        cc_x, cc_y = 1352,137
        draw.text((cc_x+2,cc_y), str(self.builder_trophies), black, font=cc_font)
        draw.text((cc_x-2,cc_y), str(self.builder_trophies), black, font=cc_font)
        draw.text((cc_x,cc_y-2), str(self.builder_trophies), black, font=cc_font)
        draw.text((cc_x,cc_y+7), str(self.builder_trophies), black, font=cc_font)
        draw.text((cc_x,cc_y), str(self.builder_trophies), white, font=cc_font)
